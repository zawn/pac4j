...
//        System.setProperty("sun.security.ssl.allowUnsafeRenegotiation", "true");
    ...
    protected void verifyProfile(CommonProfile userProfile) {
        ...
        assertEquals("DC9285E22F390A7A1437CF6F87602066", profile.getId());
        assertEquals(QQProfile.class.getName() + CommonProfile.SEPARATOR + "DC9285E22F390A7A1437CF6F87602066",
            profile.getTypedId());
        assertTrue(ProfileHelper.isTypedIdOf(profile.getTypedId(), QQProfile.class));
        assertTrue(CommonHelper.isNotBlank(profile.getAccessToken()));
        assertCommonProfile(userProfile, null, null, null, "三六五网", "三六五网",
            Gender.FEMALE, null,
            "http://thirdqq.qlogo.cn/qqapp/101480543/DC9285E22F390A7A1437CF6F87602066/100",
            null, "江苏 南京");
