...
//        System.setProperty("sun.security.ssl.allowUnsafeRenegotiation", "true");
        final RunWechatClient runTencentQQClient = new RunWechatClient();
...
//        runTencentQQClient.verifyProfile(tencentQQProfile);
    ...
    protected IndirectClient getClient() {
        ...
        final String apiKey = "wx151cc731c5138f32";
        final String apiSecret = "9794a66ae80aad3d2229aeb285657344";

        wechatClient.setKey(apiKey);
        wechatClient.setSecret(apiSecret);
        wechatClient.setCallbackUrl("http://www.xinjiakao.com/callback");
        wechatClient.addScope(WechatClient.WechatScope.snsapi_login);
        return wechatClient;
    }
