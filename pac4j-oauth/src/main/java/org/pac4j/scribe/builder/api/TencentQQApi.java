 ...
 * @since 1.9.0
 */
public class TencentQQApi extends DefaultApi20 {
    ...
    private static class InstanceHolder {
        private static final TencentQQApi INSTANCE = new TencentQQApi();
    }

    public static TencentQQApi instance() {
        return TencentQQApi.InstanceHolder.INSTANCE;
    }
