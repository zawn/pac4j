...
public class WechatProfile extends OAuth20Profile {
    ...
    public String getLocation() {
        final String location = getAttribute(WechatProfileDefinition.city) + "," + getAttribute(WechatProfileDefinition.province) + "," + getAttribute(WechatProfileDefinition.country);
        return location;
    }
