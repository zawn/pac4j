 ...
 * <p>
 * <p>More info at:
 * <a href="https://open.weixin.qq.com/cgi-bin/showdocument?action=dir_list&t=resource/res_list&verify=1&id=open1419316518&token=&lang=zh_CN">
    ...
    public WechatProfile extractUserProfile(String body) {
        ...
        if (json != null) {
            ...
            if (errcode != null && errcode > 0) {
                ...
                throw new OAuthException(errmsg != null ? errmsg.toString() : "error code " + errcode);
            }
