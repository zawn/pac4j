 ...
 * https://open.weixin.qq.com/cgi-bin/showdocument?action=dir_list&t=resource/res_list&verify=1&id=open1419316505&token=&lang=zh_CN</p>
 *
 * @author Zhang Zhenli
 * @since 3.1.0
 */
public class WechatClient extends OAuth20Client<WechatProfile> {
    ...
    protected void clientInit() {
        configuration.setApi(new WechatApi());
